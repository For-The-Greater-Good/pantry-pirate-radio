...
- **Remaining before #522 closes:** archive tiering (never destroy — archive leaves before trimming the live window so inclusion/consistency proofs survive) + dual-env retention-prune worker/Lambda + its Principle-XIV alarm.
