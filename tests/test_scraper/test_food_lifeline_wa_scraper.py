...
@pytest.mark.asyncio
async def test_download_html_success(scraper: FoodLifelineWAScraper, mock_html_response: str):
...
@pytest.mark.asyncio
async def test_scrape_html_flow(scraper: FoodLifelineWAScraper, mock_html_response: str):
...
@pytest.mark.asyncio
async def test_scrape_with_geocoding_failure(scraper: FoodLifelineWAScraper, mock_html_response: str):
