...
@pytest.mark.asyncio
async def test_fetch_results_html_success(
    scraper: FeedingTheGulfCoastALScraper, mock_html_response: str
):
...
def test_parse_results_html_empty(
    scraper: FeedingTheGulfCoastALScraper, mock_empty_html: str
):
