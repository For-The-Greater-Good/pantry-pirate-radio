"""Tests for SQSQueueBackend core functionality.

Tests for protocol compliance, initialization, setup, enqueue,
get_status, status update, and factory integration.
"""
