...
class TestScheduleUpdateOrCreate:
    ...
    def test_update_existing_schedule_with_changes(self, service_creator, sample_schedule_data):
    ...
    def test_separate_schedules_for_different_entities(self, service_creator, sample_schedule_data):
        """Test that different entities get separate schedules."""
        service_id_1 = uuid.uuid4()
        service_id_2 = uuid.uuid4()
    ...
    def test_version_tracking_on_update(self, service_creator, sample_schedule_data):
        ...
        # Update schedule
        with patch('app.reconciler.version_tracker.VersionTracker.create_version') as mock_version:
    ...
    def test_service_at_location_schedule_priority(self, service_creator, sample_schedule_data):
        """Test that service_at_location takes priority over service or location."""
        service_id = uuid.uuid4()
        location_id = uuid.uuid4()
        service_at_location_id = uuid.uuid4()
