...
| **A 211 / United Way node** | fresher, corroborated, deduped records for their coverage area; deltas instead of nightly dumps | their existing HSDS publication | Tier 0→1 | regional freshness uplift |
