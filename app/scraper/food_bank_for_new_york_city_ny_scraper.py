...
class FoodBankForNewYorkCityNyScraper(ScraperJob):
    ...
    def __init__(
        self,
        scraper_id: str = "food_bank_for_new_york_city_ny",
    ...
    async def download_kml(self) -> str:
        ...
        response = requests.get(
            self.kml_url, headers=get_scraper_headers(), timeout=self.timeout
        )
            ...
            for placemark in placemarks:
                ...
                if description:
                    ...
                    for i, line in enumerate(lines):
                        ...
                        if i == 0 or (
                            not full_address and re.search(r"\b\d{5}\b", line)
                        ):
                            full_address = line
                        ...
                        # Phone pattern
                        if "phone:" in line.lower() or re.search(
