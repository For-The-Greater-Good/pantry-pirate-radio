...
class Settings(BaseSettings):
    ...
    SUBMARINE_CRAWL_TIMEOUT: int = _SHARED["SUBMARINE_CRAWL_TIMEOUT"]
    SUBMARINE_MAX_PAGES_PER_SITE: int = _SHARED["SUBMARINE_MAX_PAGES_PER_SITE"]
    SUBMARINE_MIN_CRAWL_DELAY: int = _SHARED["SUBMARINE_MIN_CRAWL_DELAY"]
    SUBMARINE_MAX_ATTEMPTS: int = _SHARED["SUBMARINE_MAX_ATTEMPTS"]
    SUBMARINE_COOLDOWN_SUCCESS_DAYS: int = _SHARED["SUBMARINE_COOLDOWN_SUCCESS_DAYS"]
    SUBMARINE_COOLDOWN_NO_DATA_DAYS: int = _SHARED["SUBMARINE_COOLDOWN_NO_DATA_DAYS"]
    SUBMARINE_COOLDOWN_ERROR_DAYS: int = _SHARED["SUBMARINE_COOLDOWN_ERROR_DAYS"]
