...
class ValidationRules:
    ...
    def __init__(self, config: Dict[str, Any] = None):
        ...
        self.test_patterns = self.config.get(
            "test_patterns",
            getattr(settings, "VALIDATION_TEST_DATA_PATTERNS", [
        ...
        self.placeholder_patterns = self.config.get(
            ...
            getattr(settings, "VALIDATION_PLACEHOLDER_PATTERNS", [
    ...
    def check_coordinates_present(self, location: Dict[str, Any]) -> Tuple[bool, int, str]:
    ...
    def check_zero_coordinates(self, location: Dict[str, Any]) -> Tuple[bool, int, str]:
        ...
        if lat is None or lon is None:
            return (True, 0, "Valid coordinates")  # Will be caught by check_coordinates_present
    ...
    def detect_placeholder_addresses(self, location: Dict[str, Any]) -> Tuple[bool, int, str]:
    ...
    def assess_geocoding_confidence(self, location: Dict[str, Any]) -> Tuple[bool, int, str]:
    ...
    def check_missing_fields(self, location: Dict[str, Any]) -> Dict[str, Any]:
        ...
        important_fields = ["name", "address", "city", "state", "postal_code", "latitude", "longitude"]
        present_fields = sum(1 for field in important_fields if location.get(field))
        results["field_completeness"] = present_fields / len(important_fields)
    ...
    def validate_location(self, location: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if "high" in geocoding_msg.lower():
            results["geocoding_confidence"] = "high"
        elif "medium" in geocoding_msg.lower():
            results["geocoding_confidence"] = "medium"
        elif "fallback" in geocoding_msg.lower():
            results["geocoding_confidence"] = "fallback"
        else:
            results["geocoding_confidence"] = "low"
    ...
    def validate_job_data(self, job_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if "locations" in job_data:
            ...
            results["location_validations"] = location_validations
        ...
        if "services" in job_data:
            ...
            results["service_validations"] = service_validations
